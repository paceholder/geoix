...
# Generated by qmake (2.01a) (Qt 4.7.0) on: ?? ??? 30 01:45:07 2011
# Project:  geoix.pro
# Template: app
...
OBJECTS       = main.o \
		...
		data_exporter.o \
		curve.o \
		curve_load_table_model.o \
		curve_load_table_delegate.o \
		curveloaddialog.o \
		cg.o \
		moc_mainwindow.o \
		moc_project.o \
...
$(TARGET): ui_mainwindow.h ui_spliner_dialog.h ui_surf_prop_dialog.h ui_rbf_settings_widget.h ui_cubedialog.h ui_kriging_settings_widget.h ui_localb_settings_widget.h ui_curveloader.h $(OBJECTS)  
...
moc_curveloaddialog.cpp: curveloaddialog.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) curveloaddialog.h -o moc_curveloaddialog.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_spliner_dialog.h ui_surf_prop_dialog.h ui_rbf_settings_widget.h ui_cubedialog.h ui_kriging_settings_widget.h ui_localb_settings_widget.h ui_curveloader.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_spliner_dialog.h ui_surf_prop_dialog.h ui_rbf_settings_widget.h ui_cubedialog.h ui_kriging_settings_widget.h ui_localb_settings_widget.h ui_curveloader.h
...
ui_curveloader.h: curveloader.ui
	/usr/bin/uic-qt4 curveloader.ui -o ui_curveloader.h
...
fourier.o: fourier.cpp fourier.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fourier.o fourier.cpp

kiss_fft.o: fourier/kiss_fft.cpp fourier/_kiss_fft_guts.h \
		fourier/kiss_fft.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o kiss_fft.o fourier/kiss_fft.cpp

data_exporter.o: data_exporter.cpp data_exporter.h \
		point3D.h \
		contour.h \
		constants.h \
		surface_data.h \
		size.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o data_exporter.o data_exporter.cpp

curve.o: curve.cpp curve.h \
		constants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve.o curve.cpp

curve_load_table_model.o: curve_load_table_model.cpp curve_load_table_model.h \
		tree_abstract_object.h \
		well.h \
		visual_object.h \
		tree_object.h \
		...
		constants.h \
		tree_folder_object.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve_load_table_model.o curve_load_table_model.cpp

curve_load_table_delegate.o: curve_load_table_delegate.cpp curve_load_table_delegate.h \
		curve_load_table_model.h \
		tree_abstract_object.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve_load_table_delegate.o curve_load_table_delegate.cpp

curveloaddialog.o: curveloaddialog.cpp curveloaddialog.h \
		ui_curveloader.h \
		curve_load_table_model.h \
		tree_abstract_object.h \
		curve_load_table_delegate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curveloaddialog.o curveloaddialog.cpp

cg.o: cg/cg.cpp cg/cg.h \
		cg/tnt_array1d.h \
		cg/tnt_i_refvec.h \
		cg/tnt_array2d.h \
		cg/tnt_array1d_utils.h \
		cg/tnt_array2d_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cg.o cg/cg.cpp
...
moc_curveloaddialog.o: moc_curveloaddialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_curveloaddialog.o moc_curveloaddialog.cpp
